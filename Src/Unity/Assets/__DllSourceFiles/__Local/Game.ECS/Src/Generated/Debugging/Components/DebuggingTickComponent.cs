...
public partial class DebuggingEntity {
    ...
    public Lockstep.ECS.Debug.TickComponent tick { get { return (Lockstep.ECS.Debug.TickComponent)GetComponent(DebuggingComponentsLookup.Tick); } }
    ...
    public void AddTick(uint newValue) {
        ...
        var component = (Lockstep.ECS.Debug.TickComponent)CreateComponent(index, typeof(Lockstep.ECS.Debug.TickComponent));
